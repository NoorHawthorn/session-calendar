...
// lines (event names and descriptions routinely exceed this) will otherwise
// sit on one unfolded line — several parsers tolerate that, but Outlook is
// known to be strict about it. We fold by character count with a safety
// margin below 75 so multi-byte characters (e.g. em dashes) don't push the
// actual byte count over the limit.
